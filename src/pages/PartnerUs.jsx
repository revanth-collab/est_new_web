...
const PartnerUs = () => {
  return (
    <div className='partner-us px-4 md:px-10 pt-10 pb-6'>
        <div className='flex flex-col md:flex-row justify-center items-center gap-10 w-full mx-auto max-w-screen-xl'>
