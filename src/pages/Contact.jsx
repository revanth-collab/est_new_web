    ...
    <>
        ...
        <section className="py-8 px-6 sm:px-10">
            ...
            <form className="max-w-screen-xl mx-auto">
                ...
                <input type="text" placeholder="Service type" className="form-input" />
                <input type="text" placeholder="Location" className="form-input" />
                <input type="text" placeholder="Type of Outlet" className="form-input" />
                <input type="number" placeholder="No of Outlets" className="form-input" />
                <input type="text" placeholder="Do you want onboard your store?" className="form-input" />
                </div>
                ...
                <textarea
                    ...
                    className="w-full border-b border-gray-300 focus:outline-none focus:border-[#6C5DD3] text-sm px-2 py-3 bg-transparent resize-none"
                ></textarea>
                </div>
